...
Roast standing: measured per individual test, **~57% of all declared tests pass** (131,732 / ~231,098, counting tests in files that abort before running); on the stricter file bar, **307 / 1,464 fully pass (~21%)** (630 partial, 524 no-TAP, 3 timeout). See [COUNTING.md](COUNTING.md) for how these are defined.

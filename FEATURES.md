...
Roast standing: measured per individual test, **~73% of all declared tests pass** (137,199 / ~187,714, counting tests in files that abort before running); on the stricter file bar, **350 / 1,464 fully pass (~22%)** (596 partial, 514 no-TAP, 11 timeout). See [COUNTING.md](COUNTING.md) for how these are defined.

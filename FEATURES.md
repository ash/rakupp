...
Roast standing: **293 / 1,464 files fully pass (~20%)**; 613 partial, 557 no-TAP, 1 timeout. (Among files that run, 131,243 / 188,719 reached assertions pass — a correctness signal, not a coverage figure; see [ROAST.md](ROAST.md).)

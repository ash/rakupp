...
Roast standing: **282 / 1,464 files fully pass (~19%)**; 617 partial, 563 no-TAP, 2 timeout. (Among files that run, 131,052 / 188,510 reached assertions pass — a correctness signal, not a coverage figure; see [ROAST.md](ROAST.md).)

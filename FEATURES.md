...
Roast standing: **279 / 1,464 files fully pass (~19%)**; 618 partial, 565 no-TAP, 2 timeout. (Among files that run, 131,007 / 188,451 reached assertions pass — a correctness signal, not a coverage figure; see [ROAST.md](ROAST.md).)

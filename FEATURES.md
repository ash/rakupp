...
Roast standing: measured per individual test, **~74% of all declared tests pass** (139,688 / ~188,835, counting tests in files that abort before running); on the stricter file bar, **378 / 1,464 fully pass (~25%)** (623 partial, 454 no-TAP, 9 timeout). See [COUNTING.md](COUNTING.md) for how these are defined.

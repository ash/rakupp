...
**Status:** current release **v1.5.2** (2026-07-31) — *narrowing the measured gap
...
Measured per individual test, **90% of Roast passes** — 196,568 of
...
**630 / 1,462 files fully pass (~43%)** — a file counts only if *every* assertion

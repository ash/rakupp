...
- **[CACHING.md](docs/CACHING.md)** — the precompiled parse: modules and the main program are cached after their first parse; what invalidates an entry, and how to inspect or disable it.

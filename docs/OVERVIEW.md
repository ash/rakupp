...
- **All declared tests: ~90%** (196,052 / ~217,016) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~42%** (611 / 1,462) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~98%** (196,052 / 200,501) — of just the assertions files

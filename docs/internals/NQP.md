...
under many more spellings, and several whole groups the tables in both files
left out. Both also put the implementation at about 250 lines, which is roughly
a quarter of what it is.

...
2. **Execution is a tree walk.** The interpreter recursively evaluates AST
   ...
   see [MEMORY.md](../guide/MEMORY.md) for the reservations and measured depths.)
...
bypasses it, is in [DISPATCH.md](DISPATCH.md).)
...
implementation"; the [ROADMAP.md](../status/ROADMAP.md) tracks which ones are on the list to
close.

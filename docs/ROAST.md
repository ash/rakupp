...
**194,506 of ~216,066 declared tests — 90%**. "Declared" means every test the
...
|---|---|---|
| tests that **ran** | 194,506 / 199,588 (~97%) | only assertions files actually emitted — flatters, ignores aborts |
...
| S02 | Literals, types, magicals | 54 | 74 | 0 | 19 | 4500/5042 | 89% |
...
| S12 | Objects & classes | 26 | 59 | 0 | 15 | 969/1206 | 80% |
...
| integration | Cross-feature programs | 47 | 54 | 0 | 18 | 922/1035 | 89% |
...
_Snapshot: 584 / 1,462 files fully passing (~39% coverage); 700 partial,
167 no-TAP, 11 timeout (the scheduler/io timing files flap between pass and timeout under runner load). Reached-assertion pass rate 194,506 / 199,588 (see

...
- **All declared tests: ~90%** (197,111 / ~218,647) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~41%** (595 / 1,462) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~97%** (197,111 / 203,540) — of just the assertions files

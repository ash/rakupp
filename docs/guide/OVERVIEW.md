...
- **All declared tests: ~90%** (198,956 / ~218,764) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~43%** (642 / 1,464) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~97%** (198,956 / 205,437) — of just the assertions files

...
- **All declared tests: ~90%** (197,053 / ~218,589) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~41%** (593 / 1,462) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~97%** (197,053 / 203,478) — of just the assertions files

...
- **All declared tests: ~90%** (196,590 / ~217,055) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~43%** (631 / 1,462) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~98%** (196,590 / 200,826) — of just the assertions files

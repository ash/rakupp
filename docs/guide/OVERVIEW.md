...
- **All declared tests: ~91%** (200,220 / ~219,429) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~45%** (661 / 1,464) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~97%** (200,220 / 206,347) — of just the assertions files

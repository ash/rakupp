...
- **All declared tests: ~90%** (198,939 / ~218,773) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~43%** (643 / 1,464) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~97%** (198,939 / 205,416) — of just the assertions files

...
[DISPATCH.md](../../internals/DISPATCH.md). This is about the interpreter's `methodCallInner`.)
...
still in [OPTIMIZATION.md](../../internals/OPTIMIZATION.md): *"name comparison 8.5%"*. That

// GENERATED by tools/gen_unicode_scripts.py from Unicode 16.0.0 Scripts.txt — do not edit.
#include <cstdint>
#include <cstddef>
namespace rakupp { namespace ucd {
struct ScriptEnt { uint32_t lo, hi; const char* name; };
extern const ScriptEnt SCRIPTS[] = {
  {0x0,0x1F,"Common"},
  {0x20,0x20,"Common"},
  {0x21,0x23,"Common"},
  {0x24,0x24,"Common"},
  ...
  {0x560,0x588,"Armenian"},
  {0x589,0x589,"Armenian"},
...
extern const size_t SCRIPTS_N = 2253;

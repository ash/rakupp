// GENERATED by tools/gen_unicode_blocks.py from Unicode 17.0.0 Blocks.txt — do not edit.
#include <cstdint>
#include <cstddef>
...
extern const BlockEnt BLOCKS[] = {
  ...
  {0x18D80,0x18DFF,"tangutcomponentssupplement"},
  ...
  {0x1CEC0,0x1CEFF,"miscellaneoussymbolssupplement"},
  ...
  {0x323B0,0x3347F,"cjkunifiedideographsextensionj"},

...
// The protocol's JSON is JsonLite.h's — shared with `rakupp --jupyter`, which
// speaks a different protocol out of the same little value type.
using rakupp::json::Json;
using rakupp::json::dumps;
using rakupp::json::dumpStr;

...
| No TAP output (parse error / unimplemented) | 557 | 38% |
| Timeouts | 1 | 0.1% |

Two numbers describe where Raku++ stands, and they measure different things:

- **Coverage — 293 / 1,464 files fully pass (~20%).** This is the headline: how
...
- **Correctness on what runs — 131,243 / 188,719 assertions pass.** This counts
  only assertions in files that produce TAP. The 557 no-TAP files contribute

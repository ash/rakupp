...
- **Coverage — 277 / 1,464 files fully pass (~19%).** This is the headline: how
...
- **Correctness on what runs — 130,931 / 188,311 assertions pass.** This counts
  only assertions in files that produce TAP. The 574 no-TAP files contribute

...
- **All declared tests: ~57%** (132,692 / ~231,000) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~22%** (323 / 1,464) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~69%** (132,692 / 189,362) — of just the assertions files

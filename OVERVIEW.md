...
- **All declared tests: ~73%** (137,167 / ~187,714) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~22%** (349 / 1,464) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~69%** (137,167 / 146,982) — of just the assertions files

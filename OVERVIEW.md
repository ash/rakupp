...
- **All declared tests: ~76%** (143,744 / ~188,835) — the headline per-test figure.
  ...
  files can't hide.
- **Files fully passing: ~27%** (390 / 1,464) — the stricter bar; a file counts
  only if *every* assertion in it passes.
- **Tests that ran: ~93%** (143,744 / 149,126) — of just the assertions files
